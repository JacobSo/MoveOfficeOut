        ...
        return (
            <TouchableOpacity
                ...
                <View style={styles.itemText}>
                    <Text>{'客户'}</Text>
                    <Text
                        style={{color: Color.black_semi_transparent}}>{this.props.rowData.customer}</Text>
                </View>
                <View style={styles.itemText}>
                    <Text>{'供应商'}</Text>
                    <Text style={{color: Color.black_semi_transparent}}>{this.props.rowData.material_supplier}</Text>
                </View>
                <View style={styles.itemText}>
                    <Text>{'创建时间'}</Text>
